...
output_file = path_to_local_home + '/yellow_tripdata_{{execution_date.strftime(\'%Y-%m\')}}.csv'
...
with gcp_upload_workflow:
    ...
    remove_from_local_task = BashOperator(
        task_id="remove_from_local_task",
